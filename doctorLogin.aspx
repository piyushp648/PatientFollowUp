<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doctorLogin.aspx.cs" Inherits="Default5" %>
...
<body>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="doctorLogin.aspx">Doctor</a></li>
...
<div class="container-fluid bg">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-4 col-xs-12">
                 <form id="formLoginDoctor" runat="server" class="form-horizontal form-box">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="doctor/home.aspx" CssClass="btn btn-success btn-block btn-enlarge">Login</asp:HyperLink>
                        </div>
                    </div>
                </form>
            </div>
