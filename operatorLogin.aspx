<%@ Page Language="C#" AutoEventWireup="true" CodeFile="operatorLogin.aspx.cs" Inherits="Default4" %>
                 ...
                 <form id="formLoginOperator" runat="server" class="form-horizontal form-box">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="operator/home.aspx" CssClass="btn btn-success btn-block btn-enlarge">Login</asp:HyperLink>
