<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chemistLogin.aspx.cs" Inherits="Default3" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="chemistLogin.aspx">Chemist</a></li>
                 ...
                 <form id="formLoginChemist" runat="server" class="form-horizontal form-box">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4 col-sm-8 col-md-8 col-xs-12">
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="chemist/home.aspx" CssClass="btn btn-success btn-block btn-enlarge">Login</asp:HyperLink>
